...
var sys_api = require('./resources/api/api_router');
...
var SampleApp = function() {
    ...
    self.createPostRoutes = function() {
        ...
        self.postRoutes['/uploadStory'] = function(req, res) {
            sys_api.incomingRouteRequest(req,res,'uploadreq');
        }
    ...
    self.createRoutes = function() {
        ...
        self.routes['/loguser'] = function(req, res) {
            sys_api.incomingRouteRequest(req,res,'loguser');
